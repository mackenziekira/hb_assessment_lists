...
def smallest_int(numbers):
    ...
    **DO NOT USE** the built-in function `min()`!
    ...
    If the input list is empty, return `None`::
        ...
        True
    """
    # uses conditional expression (fewest lines of code, still readable)
    return sorted(numbers)[0] if numbers != [] else None

    # uses more traditional conditionals
    # if numbers == []:
    #     return None
    # else:
    #     return sorted(numbers)[0]

    # uses n.sort(), which is more efficient than sorted(n)
    # if numbers == []:
    #     return None
    # else:
    #     numbers.sort()
...
def largest_int(numbers):
    ...
    **DO NOT USE** the built-in function `max()`!
    ...
    return sorted(numbers).pop() if numbers != [] else None

    #uses reverse parameter of sorted function to sort largest to smallest
    #return sorted(numbers, reverse = True)[0] if numbers != [] else None

    # uses n.sort() with the reverse parameter, which is more efficient than sorted(n)
    # if numbers == []:
    #     return None
    # else:
...
def average(numbers):
    ...
    """
    if numbers == []:
        return "There is no defined answer for an empty list. Please input a populated list."
    else:
